...
root.configure(bg="black")      # color of the window
root.geometry(f'{settings.WIDTH}x{settings.HEIGHT}')       # size of window (widthxheight)
root.title("Minesweeper Game")
root.resizable(False, False)    # prevents resizing the window
